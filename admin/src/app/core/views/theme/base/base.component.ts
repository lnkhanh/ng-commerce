...
// Layout
import { LayoutConfigService, MenuConfigService, PageConfigService } from '@core/views/layout';
import { HtmlClassService } from '../html-class.service';
import { LayoutConfig } from '@core/views/_config/layout.config';
import { MenuConfig } from '@core/views/_config/menu.config';
import { PageConfig } from '@core/views/_config/page.config';
// User permissions
import { NgxPermissionsService } from 'ngx-permissions';
import { currentUserPermissions, Permission } from '@app/modules/auth';
