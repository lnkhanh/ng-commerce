...
export const getUsers = wrap(async (req: ISessionRequest, res: Response) => {
  const { pageIndex, pageSize, keyword } = req.query;
  const roles = [PermissionEnum.SystemUser, PermissionEnum.StaffUser];
...
export const newUser = wrap(async (req: ISignUpRequest, res: Response) => {
...
export const getUser = wrap(async (req: ISessionRequest, res: Response) => {
  const { id } = req.params;
...
export const updateUser = wrap(async (req: ISessionRequest, res: Response) => {
  const { id } = req.params;
...
export const removeUser = wrap(async (req: ISessionRequest, res: Response) => {
  const { id } = req.params;
...
export const saveUploadAvatar = wrap(async (req: ISessionRequest, res: Response) => {
...
export const removeUserAvatar = wrap(async (req: ISessionRequest, res: Response) => {
  const { userId } = req.params;
